...
function getCountTruckWait(){
    if(executeResult("SELECT * FROM tbl_truck") != null)
        return count(executeResult("SELECT * FROM tbl_truck WHERE status = 0 "));
    else
        return 0;
}
...
function getDriverNotWork(){
    return count(executeResult("SELECT * FROM tbl_driver WHERE status_work = 0"));
}
            ...
            <div class="row">
                <div class="col-md-4" style="margin-top: 2rem">
                    <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <canvas id="myChartTwo" style="height: 370px; width: 100%;"></canvas>
                    </div>
                </div>

                <div class="col-md-4" style="margin-top: 2rem">
                    <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <canvas id="myChartThree" style="height: 370px; width: 100%;"></canvas>
                    </div>
                </div>

                <div class="col-md-4" style="margin-top: 2rem">
                    <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <canvas id="myChartFour" style="height: 370px; width: 100%;"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    window.onload = function () {
        var chart = new CanvasJS.Chart("myChartOne", {
            ...
            data: [{
                ...
                dataPoints: [
                    { y: <?php echo $y1?>, label: "Total truck" },
                    { y: <?php echo $y2?>,  label: "Truck expried" },
                    { y: <?php echo $y3?>,  label: "Truck Active" },
                    { y: <?php echo $y4?>,  label: "Truck wait" },
                    { y: <?php echo $y5?>,  label: "Truck work" },
                    { y: <?php echo $y6?>, label: "Total driver" },
                    { y: <?php echo $y7?>, label: "Driver unactive" },
                    { y: <?php echo $y8?>, label: "Driver active" },
                    { y: <?php echo $y9?>, label: "Driver work" },
                    { y: <?php echo $y10?>, label: "Driver wait" },
                    { y: <?php echo $y11?>, label: "Total transport" },
                    { y: <?php echo $y12?>, label: "Transport Success" },
                    { y: <?php echo $y13?>, label: "Transport wait" },
                ]
            }]
        });
        chart.render();
        ...
        var xValues2 = ["Lịch trình đang chờ", "Lịch trình thành công"];
